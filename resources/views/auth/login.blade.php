...
<head>
    ...
    <title>Login | Career Counseling Alumni Portal</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="javascript:void(0)" />
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Welcome to Alumni Portal! 👋</h4>
                        <p class="mb-4">Please sign-in to your account and start the career counseling.</p>
