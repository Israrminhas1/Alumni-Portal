...
<body>
    ...
    <script type="text/javascript">
        ...
        var upload_Image = '{{ URL::to('resume-template/uploadimage') }}';
        var url_load_template = "{{ URL::to('resume-template/loadtemplate') }}";
        var url_default_css_template = '{{ asset('assets/css/font-awesome.css') }}';
        var urlStore = '{{ URL::to('settings/resume-template/update-builder/' . $data->id) }}';
        var urlLoad = '{{ URL::to('settings/resume-template/load-builder/' . $data->id) }}';
        var back_button_url = "{{ URL::to('settings/resume-template') }}";
    ...
    <script src="{{ asset('assets/js/admin-builder.js') }}"></script>
